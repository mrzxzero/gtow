...
🌷 KALAU MAU RENAME TARO CREDITS GUA : Monzki*/
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC Casper`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": ppnyauser,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted:m})} 
//=================================================//
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC Casper`,"body": `Selamat ${salam} kak ${pushname}`,
...
haikal.sendListMsg(Pe, `Casper`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here `, touchmebre, m)
break
//=================================================//
...
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone1}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone2}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone3}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone4}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone5}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${iphone6}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${buttonkal}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${buttonvirus}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `ᴀʀғᴀɴ${ngazap(prefix)}`}, { quoted:m })
}
}
break
case 'sendvirus': {
...
haikal.sendMessage(m.chat, anuala, `ᴀʀғᴀɴ${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
Untuk Harga Custom WhatsApp 50k Boleh Request Fitur Tampilam Nama Dan Logo Yah Hub: wa.me/62895403595055`)
}
break
//=================================================//
case 'nodemodules': {
...
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+5000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+10000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+15000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+20000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+25000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+300000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+50000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+100000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+150000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/62895403595055?text=Beli+Pulsa+Mas+Yang+200000
...
Haikal-
Wa.me/62895403595055?text=Bang+Jasa+Run
